...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='historicalanswer',
            name='question',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='qna.question'),
        ),
        migrations.AddField(
            model_name='answer',
            name='question',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='questions', to='qna.sourcematerial'),
        ),
        migrations.AddField(
            model_name='historicalquestion',
            name='source_material',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='qna.sourcematerial'),
        ),
        migrations.AddField(
            model_name='vote',
            name='content_type',
